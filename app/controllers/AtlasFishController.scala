...
import beans.types.ApiErrorType
...
object AtlasFishController extends Controller {
  ...
  */
  ...
  @ApiParamsImplicit(Array(
    new ApiParamImplicit(name = "atlasFish", value = "Un poisson de l'Atlas", required = true, dataType = "beans.atlas.fish.AtlasFish", paramType = "body")))
