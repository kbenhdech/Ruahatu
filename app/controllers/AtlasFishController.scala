...
object AtlasFishController extends Controller {
  ...
  */
  ...
  @ApiErrors(Array(new ApiError(code = 404, reason = "Poisson de l'Atlas non trouvé")))
  def deleteAtlasFishByScientificName(@ApiParam(value = "Nom Scientifique du poisson de l'Atlas")@PathParam("scientificName") scientificName: String) = Action { implicit request =>
  ...
  @ApiErrors(Array(new ApiError(code = 400, reason = "Poisson de l'Atlas non trouvé")))
  ...
  def createAtlasFishByScientificName() = Action { implicit request =>
